...
# data = pd.read_csv(r"F:\PERL\Perl_BaseLine\1031NN_lookup_table_NNBaseLine_data.csv")
...
# ax_main.set_title('NN BaseLine (Single Robot)', fontsize=36)
...
# 添加子图（嵌入局部放大图）
ax_inset = fig.add_axes([0.62, 0.22, 0.25, 0.25]) # [x, y, width, height] 设置子图位置
