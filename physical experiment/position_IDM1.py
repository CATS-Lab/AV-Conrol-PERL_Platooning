...
# data = pd.read_csv(r"F:\PERL\Perl_BaseLine\Perl_IDM\1113NN_lookup_table_NN50Epoch_data_IDM1.csv")
# data = pd.read_csv(r"F:\PERL\Perl_BaseLine\Perl_IDM\1106NN_lookup_table_PERL_data_IDM1.csv")
data = pd.read_csv(r"F:\PERL\Perl_BaseLine\Perl_IDM\1113NN_lookup_table_Physical_data_IDM1.csv")
...
ax_main.plot(x_values_filtered, filtered_rob_1_position, label='Rob_1 Position', linewidth=6, color='blue')
